...
<div class="equip-intro-strip">
    <div class="equip-intro-inner">
        ...
        <p class="equip-intro-tagline">BSAS builds exploration equipment for conditions where conventional machines fall short — terrain, access, depth, or duty.</p>
    </div>
</div>

<!-- MPR SECTION -->
<section class="mpr-section mpr-dark">
    <div class="mpr-split">
            ...
            <div class="mpr-features mpr-features-grid">
                <div class="mpr-feature" data-aos="fade-up" data-aos-delay="0">
                    <div class="mpr-feature-icon">
                        <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <path d="M9.5 18h5" stroke="currentColor" stroke-width="1.8" stroke-linecap="round"/>
                            <path d="M12 3a6 6 0 0 1 4.24 10.24C15.4 14.08 15 15 15 15.5V16H9v-.5c0-.5-.4-1.42-1.24-2.26A6 6 0 0 1 12 3z" stroke="currentColor" stroke-width="1.8" stroke-linejoin="round"/>
                        </svg>
                    </div>
                    <div class="mpr-feature-text">
                ...
                <div class="mpr-feature" data-aos="fade-up" data-aos-delay="300">
                    ...
                    <div class="mpr-feature-text">
                        ...
                        <p>1400 Nm max torque rotary head</p>
                    </div>
                </div>
            </div>

            <div class="mpr-btns">
                <a href="/support" class="btn">Know More ↗</a>
                <a href="/support" class="btn btn-outline btn-outline-light">Technical Sheet ↗</a>
            </div>
        </div>
        ...
        <div class="mpr-specs" data-aos="fade-left">
            ...
            <h3 class="spec-heading">Technical Specifications</h3>
            <div class="spec-grid">
                <table class="spec-table">
                    <tr><td>Application</td><td>Surface Exploration</td></tr>
                    <tr><td>Type of Drilling</td><td>Diamond Core Drilling</td></tr>
                    <tr><td>Drill Rod Size</td><td>BQ | NQ | HQ</td></tr>
                    <tr><td>Capacity</td><td>500 | 400 | 150 mtr</td></tr>
                    <tr><td>Prime Movers</td><td>Diesel Engine - 2 Nos</td></tr>
                    <tr><td>Prime Mover Power</td><td>41 kW x 2</td></tr>
                    <tr><td>Hydraulic Pressure</td><td>22 MPa</td></tr>
                </table>
                <table class="spec-table">
                    <tr><td>Rotary Head</td><td>Max&nbsp;Torque : 1400 Nm</td></tr>
                    <tr><td>Pull Up Force</td><td>70 kN</td></tr>
                    <tr><td>Pull Down Force</td><td>35 kN</td></tr>
                    <tr><td>Wireline Winch</td><td>1 Ton</td></tr>
                    <tr><td>Main Winch</td><td>4.2 Ton</td></tr>
                    <tr><td>Type of Cooling</td><td>Air Cooled</td></tr>
                    <tr><td>Type of Mounting</td><td>Modular</td></tr>
                </table>
            </div>
        </div>
    </div>
...
<section class="section mii-section mii-accent">
    <div class="mii-split">
        <div class="mii-text" data-aos="fade-right">
            ...
            <ul class="mii-bullets">
                <li>Designed, assembled &amp; validated entirely in India</li>
                <li>Shorter delivery lead times vs. imported alternatives</li>
...
<section class="video-section-wrap">
    <div class="video-placeholder video-dark">
        <button class="play-btn video-play-lg" type="button">&#9654;</button>
        <div class="video-overlay-text">
            <span class="video-eyebrow">Field Performance</span>
            <p>Introducing Man Portable Drill Rig</p>
        </div>
    </div>
</section>

<!-- OUR RANGE + BRANDS WRAPPER -->
<div class="range-brands-wrapper">

<!-- OUR RANGE + EXPANDING HORIZONS -->
<div class="range-brands-block">
    <div class="range-inner">
        <div class="range-heading">
            <div class="section-label range-label">Product Range</div>
            <h2>Our<br>Range</h2>
        </div>
    ...
    <div class="expanding-heading">
        <h2>Expanding Horizons<br>With Leading Brands</h2>
    </div>
</div>
...
<div class="brands-section">
    ...
    <div class="brand-cards">
        ...
        <div class="brand-card" data-aos="fade-up" data-aos-delay="200">
            ...
            <p class="brand-card-desc">Comprehensive range of mining and exploration machinery with international certifications and field validation.</p>
            <a href="/support" class="brand-card-link">View Range ↗</a>
        </div>
    </div>
</div>

</div><!-- /range-brands-wrapper -->
