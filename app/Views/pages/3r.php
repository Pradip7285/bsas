<!-- HERO -->
<section class="hero">
    <div class="hero-bg bg-3r"></div>
    <div class="hero-content">
        <h1>Reuse. <span class="accent">Repair.</span><br>Recycle.</h1>
    </div>
</section>
...
<section class="section section-grey">
    <div class="why-3r">
        ...
        <div class="why-3r-text">
            ...
            <ul>
                <li>A trader can offer discounted parts.</li>
                <li>A workshop can offer repairs.</li>
                <li>An OEM can offer new components.</li>
            </ul>
            <p>None of them can offer what BSAS offers: the decision about whether to rebuild, remanufacture, or replace — made by engineers who understand the machine, the application, and the lifecycle.</p>
        </div>
    </div>
</section>
...
<section class="section-sm" style="padding-left:8vw;padding-right:8vw;">
    <div class="video-placeholder" style="background:#d8ffe5;">
        <button class="play-btn">▶</button>
        <p>Sustainability Programme — BSAS 3R</p>
    </div>
