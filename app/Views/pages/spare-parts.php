...
<section class="hero">
    <div class="hero-media">
        <div class="hero-bg pattern hero-bg-spare"></div>
        <img src="../assets/images/SparePart.webp" alt="Spare Parts" class="hero-img">
        <div class="hero-overlay"></div>
    </div>
    <div class="hero-content">
        <h1>One Engineering Brain<br>Every <span class="accent">Critical Spare</span></h1>
    </div>
</section>
        ...
        <div data-aos="fade-left">
            <div class="parts-diagram">
                ...
                <div class="parts-tag-row">
                    <span class="parts-tag">Axles &amp; Transmission</span>
                    <span class="parts-tag">Hydraulic Pump &amp; Motors</span>
                    <span class="parts-tag">Drifter Components</span>
                    <span class="parts-tag">Drive Manifolds</span>
                    <span class="parts-tag">Engine Spares</span>
                </div>
                <div class="parts-tag-row" style="margin-top:12px;">
                    <span class="parts-tag">Cylinders</span>
                    <span class="parts-tag">Filters</span>
                    <span class="parts-tag">Clutch Kits</span>
                    <span class="parts-tag">Exhaust Muffler</span>
                    <span class="parts-tag">Gearbox</span>
                </div>
            </div>
        </div>
    </div>
...
<section>
    <img src="../assets/images/SpareParts.png" alt="Spare Part Diagram" style="width:100%;border-radius:8px;">
</section>

<!-- VIDEO -->
<section class="section-sm" style="padding-left:8vw;padding-right:8vw;">
    <div class="video-placeholder" id="video-section">
        <button class="play-btn">▶</button>
        <p>BSAS Engineered Components. Built for Heavy Equipment that Cannot Stop.</p>
    </div>
    <div class="text-center mt-24">
        <a href="/e-shop" class="btn">Order Now ↗</a>
    </div>
</section>
